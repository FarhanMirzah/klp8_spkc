<?php
include("connect.php");
$query = mysqli_query($koneksi, "SELECT max(id_kos) as kodeTerbesar FROM kos");
            ...
            <div class="row" >
                <nav aria-label="breadcrumb" style="margin-top:35px;">
                    ...
                    <li class="active" aria-current="page">
                        <a href="addBobot.php" class="btn btn-sm shadow-sm px-3" style="background-color: #ff7f5c; color: #fff; font-weight:600;font-size: 17px; border-radius: 10px;">Add Kos</a>
                    </li>
                    </ol>
                </nav>
            </div>
                    ...
                    <div class="card mb-4" style="border-radius: 10px;">
                        <div class="card-body" style="box-shadow: 0px 4px 4px 3px rgba(0, 0, 0, 0.25);border-radius: 10px;">
                            <div class="container-fluid">
                                <form action="addKosBE.php" method="POST">
                                    <div class="row">
                                        <div class="row g-3">
                                            <h5 align="center" style="margin-top:10px;margin-bottom:15px;">Add Kos</h5> 
                                            <div class="col-md-4">
                                            <label for="id_kos">ID Kos</label>
                                            <input type="int" class="form-control" readonly value="<?php echo $kode?>" name="id_kos" required>
                                            </div>
                                            ...
                                            <a class="btn btn-danger" href="daftarKos.php">Cancel</a>
                                            </div>
                                        </div>
                                    </div>
                                </form>
