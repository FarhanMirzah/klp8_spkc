...
<body id="body-pd">
    ...
    <div>
        <h5 style="margin-top:80px;margin-bottom:15px;">Bobot Kriteria</h5>
            <div class="row">
                <div class="col-12">
                    <div class="card mb-4" style="border-radius: 10px;">
                        <div class="card-body" style="box-shadow: 0px 4px 4px 3px rgba(0, 0, 0, 0.25);border-radius: 10px;">
                            <div class="container-fluid">
                                <p align="right"><a class='btn btn-primary' href="addBobot.php"> + Bobot Kriteria</a></p>
                                <table id="myTable" class="table table-bordered table-hover" >
                                    ...
                                    ?>
                                        <tr class='td' bgcolor='#FFF'>
                                            ...
                                            <a class='btn btn-warning' href="editBobot.php?id=<?php echo $row['id_kriteria']; ?>">
                                                Ubah
                                                </a>
                                            <a class='btn btn-danger' onclick="return confirm('Anda yakin menghapus data ini ?')" href="hapusBobot.php?id=<?php echo $row['id_kriteria']; ?>">
                                                Hapus
                                                </a>
                                            </td>
                                        </tr>
