...
if (isset($_GET['id'])) 
    {
        ...
        $id_kriteria = mysqli_fetch_assoc($result);
        if (!count($id_kriteria)) 
        {
            ...
            <div class="row" >
                <nav aria-label="breadcrumb" style="margin-top:75px;">
                    ...
                    <li class="active" aria-current="page">
                        <a href="addBobot.php" class="btn btn-sm shadow-sm px-3" style="background-color: #ff7f5c; color: #fff; font-weight:600;font-size: 17px; border-radius: 10px;">Edit Bobot Kriteria</a>
                    </li>
                    </ol>
                </nav>
            </div>
                        ...
                        <div class="card-body" style="box-shadow: 0px 4px 4px 3px rgba(0, 0, 0, 0.25);border-radius: 10px;">
                            <div class="container-fluid">
                                <form action="addBobotBE.php" method="POST">
                                    <div class="row">
                                        <div class="col">
                                            <h5 align="center" style="margin-top:10px;margin-bottom:15px;">Edit Bobot Kriteria</h5>
                                            <div class="form-group">
                                            <label for="id_kriteria">ID Kriteria</label>
                                            <input type="int" class="form-control" name="id_kriteria" readonly value="<?php echo $id_kriteria['id_kriteria']; ?>" required>
                                            </div>

                                            <div class="form-group">
                                            <label for="nama_kriteria">Nama Kriteria</label>
                                            <input type="text" class="form-control" name="nama_kriteria" value="<?php echo $id_kriteria['nama_kriteria']; ?>" required>
                                            </div>
                                            ...
                                            ?>
                                            <option readonly selected value="<?php echo $id_kriteria["atribut"]?>"><?=$atribut?></option>;
                                            ...
                                            <?php
                                            if ($id_kriteria['bobot_nilai']=="1"){
                                                $bobot_nilai = "1";
                                            }
                                            else if ($id_kriteria['bobot_nilai']=="2"){
                                                $bobot_nilai = "2";
                                            }
                                            else if ($id_kriteria['bobot_nilai']=="3"){
                                                $bobot_nilai = "3";
                                            }
                                            else if ($id_kriteria['bobot_nilai']=="4"){
                                                $bobot_nilai = "4";
                                            }
                                            else{
                                                $bobot_nilai = "5";
                                            ...
                                            ?>
                                            <option readonly selected value="<?php echo $id_kriteria["bobot_nilai"]?>"><?=$bobot_nilai?></option>;
